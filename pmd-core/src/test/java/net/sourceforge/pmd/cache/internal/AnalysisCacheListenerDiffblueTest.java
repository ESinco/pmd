...
class AnalysisCacheListenerDiffblueTest {
    ...
    void testStartFileAnalysis() throws IOException {
        ...
        AnalysisCacheListener analysisCacheListener = new AnalysisCacheListener(cache, ruleSets, classLoader,
                new ArrayList<>());

        // Act
        FileAnalysisListener actualStartFileAnalysisResult = analysisCacheListener
                .startFileAnalysis(new SimpleTestTextFile("Not all who wander are lost", FileId.STDIN, null));
