...
class CpdAnalysisDiffblueTest {
    ...
    void testCreate2() {
        ...
        assertTrue(reporter instanceof SimpleMessageReporter);
        assertEquals(0, reporter.numErrors());
        assertEquals(1, filesResult.getCollectedFiles().size());
    }
    ...
    void testCreate4() {
        // Arrange
        CPDConfiguration config = new CPDConfiguration();
        config.addInputPath(Paths.get(System.getProperty("java.io.tmpdir"), "UU"));
    ...
    void testCreate5() {
        ...
        assertTrue(reporter instanceof SimpleMessageReporter);
        assertEquals(0, reporter.numErrors());
        assertEquals(6, filesResult.getCollectedFiles().size());
    }
    ...
    void testCreate14() {
        // Arrange
        CPDConfiguration config = new CPDConfiguration();
        config.setInputFilePath(Paths.get(System.getProperty("java.io.tmpdir"), "UU"));
        config.addInputPath(Paths.get(System.getProperty("java.io.tmpdir"), "test.txt"));
    ...
    void testCreate16() {
        // Arrange
        CPDConfiguration config = new CPDConfiguration();
        config.setIgnoreFilePath(Paths.get(System.getProperty("java.io.tmpdir"), "UU"));
        config.addInputPath(Paths.get(System.getProperty("java.io.tmpdir"), "test.txt"));
    ...
    void testPerformAnalysis6() throws IOException {
        // Arrange
        CPDReportRenderer renderer = mock(CPDReportRenderer.class);
        doThrow(new IOException("UUU")).when(renderer).render(Mockito.<CPDReport>any(), Mockito.<Writer>any());
     ...
     */
    @Test
    void testPerformAnalysis7() throws IOException {
        // Arrange
        CPDReportRenderer renderer = mock(CPDReportRenderer.class);
     ...
     */
    @Test
    void testPerformAnalysis8() throws IOException {
        // Arrange
        CPDReportRenderer renderer = mock(CPDReportRenderer.class);
        doThrow(InternalApiBridge.newLexException(true, "UUU", -1, -1, "An error occurred", '\u0003')).when(renderer)
     ...
     */
    @Test
    void testPerformAnalysis13() throws IOException {
        // Arrange
        CPDReportRenderer renderer = mock(CPDReportRenderer.class);
        doNothing().when(renderer).render(Mockito.<CPDReport>any(), Mockito.<Writer>any());
     ...
     */
    @Test
    void testPerformAnalysis14() throws IOException {
        // Arrange
        CPDReportRenderer renderer = mock(CPDReportRenderer.class);
     ...
     */
    @Test
    void testPerformAnalysis15() throws IOException {
        // Arrange
        CPDReportRenderer renderer = mock(CPDReportRenderer.class);
        doThrow(new FileAnalysisException()).when(renderer).render(Mockito.<CPDReport>any(), Mockito.<Writer>any());
     ...
     */
    @Test
    void testPerformAnalysis16() throws IOException {
        // Arrange
        CPDReportRenderer renderer = mock(CPDReportRenderer.class);
