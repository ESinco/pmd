...
class SourceManagerDiffblueTest {
    ...
    void testGet() {
        ...
        // Act
        sourceManager.get(new SimpleTestTextFile("Not all who wander are lost", CpdTestUtils.BAR_FILE_ID, null));
    }
    ...
    void testGetSlice() {
        ...
        // Act
        sourceManager.getSlice(new Mark(null));
    }
    ...
    void testGetFileDisplayName() {
        // Arrange, Act and Assert
        assertEquals("C:\\var\\Bar.java",
                (new SourceManager(new ArrayList<>())).getFileDisplayName(CpdTestUtils.BAR_FILE_ID));
    }
