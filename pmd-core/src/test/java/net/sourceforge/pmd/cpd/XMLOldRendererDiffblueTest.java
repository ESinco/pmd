...
class XMLOldRendererDiffblueTest {
    ...
    void testNewXMLOldRenderer() throws IOException {
        ...
        // Assert
        String expectedToStringResult = String.join("", "<?xml version=\"1.0\" encoding=\"",
                System.getProperty("sun.jnu.encoding"), "\"?>\n<pmd-cpd/>\n");
        assertEquals(expectedToStringResult, writer.toString());
    }
    ...
    void testRender5() throws IOException {
        ...
        String expectedToStringResult = String.join("", "<?xml version=\"1.0\" encoding=\"",
                System.getProperty("sun.jnu.encoding"),
                "\"?>\n<pmd-cpd>\n   <file path=\"C:\\var\\Bar.java\" totalNumberOfTokens=\"1\"/>\n</pmd-cpd>\n");
        assertEquals(expectedToStringResult, writer.toString());
    }
